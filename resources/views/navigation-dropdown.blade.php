<nav x-data="{ open: false }" class="shadow-md bg-white px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="h-full hidden sm:flex">
                ...
                @if (Route::has('register'))
                    <x-jet-nav-link class="ml-8" href="{{ route('register') }}" :active="request()->routeIs('register')">
                        {{ __('Register') }}
                    </x-jet-nav-link>
                @endif
            </div>
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                <div class="flex items-center px-4">
                    <div class="flex-shrink-0">
                        <img class="h-10 w-10 rounded-full border-2 border-blue-200 bg-cover bg-center" src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" />
                    </div>
