<div x-cloak x-data="{modalOpen:false}" class="w-full px-4 py-3 text-center border border-gray-200 rounded-md my-4">
    ...
    <x-textarea class="font-mono prolog-files outline-none bg-blue-50 w-full py-2 px-4 rounded-md shadow" name="content" wire:model="prologFile.content" wire:keydown.debounce.200ms="save()" rows="10"></x-textarea>
